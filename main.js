      ...
      start() {
          ...
          Swal.fire({
              ...
              if (result.isConfirmed) {
                  ...
                  welcomeText.innerHTML = `Hello, ${this.playerName}! Let's start the game!`;
                  this.playLevel();
              } else {
      ...
      playLevel() {
          ...
          const fallInterval = setInterval(() => {
              ...
              if (this.successfulWords === 10) {
                  ...
                  Swal.fire({
                      title: 'Wohooo!',
                      text: `You've reached Level ${this.level}.`,
                      icon: 'success',
